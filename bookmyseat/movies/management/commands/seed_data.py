...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        movies_data = [
            ...
            {
                'title': 'The Paradise',
                'description': 'In 1980s Secunderabad, a marginalized tribe battles discrimination and fights for citizenship under an unexpected leader\'s guidance. Starring Nani and Janhvi Kapoor, this gripping action thriller directed by Srikanth Odela challenges systemic oppression with music by Anirudh Ravichander.',
                'duration': 0,
